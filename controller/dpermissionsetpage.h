#ifndef DPERMISSIONSETPAGE_H
#define DPERMISSIONSETPAGE_H
...
class DPermissionSetPage:  public CSubPage
{
    Q_OBJECT
public:
    enum TABPAGE
...
public:
    DPermissionSetPage(QObject *parent = 0,CBaseWidget *widget = 0 , MainWindow *wndMain = 0);
