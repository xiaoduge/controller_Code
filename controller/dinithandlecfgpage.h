#ifndef DINITHANDLECFGPAGE_H
#define DINITHANDLECFGPAGE_H
...
class DInitHandleCfgpage : public CSubPage
{
    Q_OBJECT

public:
    DInitHandleCfgpage(QObject *parent = 0,CBaseWidget *widget = 0 , MainWindow *wndMain = 0);
