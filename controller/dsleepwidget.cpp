...
DSleepWidget::DSleepWidget(const QString& msg, int screenWidth, int screenHeight, QWidget *parent) :
    QWidget(parent),
...
void DSleepWidget::setMsg(const QString &msg)
{
    m_msg = msg;
}

void DSleepWidget::setPos(int x, int y)
{
    m_pos.setX(x);
    m_pos.setY(y);
}

void DSleepWidget::paintEvent(QPaintEvent *event)
{
