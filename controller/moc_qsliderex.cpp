...
static const char qt_meta_stringdata_CSliderEx[] = {
    "CSliderEx\0\0,\0valueChanged(int,int)\0"
    "ivalue\0on_value_changed(int)\0"
};
...
void CSliderEx::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CSliderEx *_t = static_cast<CSliderEx *>(_o);
        switch (_id) {
        case 0: _t->valueChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->on_value_changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CSliderEx::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CSliderEx::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_CSliderEx,
      qt_meta_data_CSliderEx, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CSliderEx::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CSliderEx))
...
// SIGNAL 0
void CSliderEx::valueChanged(int _t1, int _t2)
{
