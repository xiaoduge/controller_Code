...
Ex_Languagepage::Ex_Languagepage(QObject *parent,CBaseWidget *widget ,MainWindow *wndMain) : CSubPage(parent,widget,wndMain)
{
...
void Ex_Languagepage::creatTitle()
{
    CSubPage::creatTitle();
...
void Ex_Languagepage::buildTitles()
{
...
void Ex_Languagepage::buildTranslation()
{
...
void Ex_Languagepage::switchLanguage()
{
    buildTranslation();
...
void Ex_Languagepage::setBackColor()
{
...
void Ex_Languagepage::on_saveBtn_clicked()
{
...
void Ex_Languagepage::leaveSubPage()
{
    if (m_iLanguage != gGlobalParam.MiscParam.iLan)
    {
       DISP_MISC_SETTING_STRU  MiscParam = gGlobalParam.MiscParam;
