...
DInitTimePage::DInitTimePage(QObject *parent,CBaseWidget *widget ,MainWindow *wndMain) : CSubPage(parent,widget,wndMain)
{
    creatTitle();
...
void DInitTimePage::buildTitles()
{
...
void DInitTimePage::buildTranslation()
{
    int iLoop;
...
void DInitTimePage::switchLanguage()
{
    buildTranslation();
...
void DInitTimePage::setBackColor()
{
...
void DInitTimePage::createHeads()
{
    QPixmap PixTit;
...
void DInitTimePage::Create_Cal_Ok()
{
...
void DInitTimePage::Create_Date_Time()
{
    int iLoop;
...
void DInitTimePage::mousePressEvent(QMouseEvent *e)
{
    if (!m_lstFlag)
    {
        m_lstX = e->x();
...
void DInitTimePage::mouseMoveEvent(QMouseEvent *e)
{
    if (0 == e->x()
        && 0 == e->y())
    {
...
void DInitTimePage::mouseReleaseEvent(QMouseEvent *e)
{
...
void DInitTimePage::Date_show_hide(bool show)
{
    if(show)
    {
        CalS->show();
...
void DInitTimePage::Time_show_hide(bool show)
{
    if(show)
    {
        QDateTime sysDateTime;
...
void DInitTimePage::on_Ok_clicked()
{
    if(CalS->isVisible())
    {
...
void DInitTimePage::on_Cancel_clicked()
{
    if(CalS->isVisible())
    {
        Date_show_hide(false);
...
void DInitTimePage::on_btn_clicked(int index)
{
    switch(index)
    {
...
void DInitTimePage::on_ExNextBtn_clicked()
{
    m_wndMain->naviInitPage(Ex_Init_Time, 0);
    m_wndMain->prepareKeyStroke();
}

void DInitTimePage::on_ExBackBtn_Clicked()
{
    m_wndMain->naviInitPage(Ex_Init_Time, 1);
    m_wndMain->prepareKeyStroke();
}

void DInitTimePage::changeTime()
{
    //QDateTime time;
    time_t    Time_t;
    struct tm curtime;
