#ifndef EX_WATERQUALITYPAGE_H
#define EX_WATERQUALITYPAGE_H
...
class Ex_WaterQualityPage : public CSubPage
{
    Q_OBJECT
public:
...
public:
    Ex_WaterQualityPage(QObject *parent = 0,CBaseWidget *widget = 0 , MainWindow *wndMain = 0);
