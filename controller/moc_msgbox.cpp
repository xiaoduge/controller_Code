...
static const char qt_meta_stringdata_MsgBox[] = {
    "MsgBox\0\0on_Ok_clicked(int)\0"
    "on_Cal_clicked(int)\0"
};
...
void MsgBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_Ok_clicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_Cal_clicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
