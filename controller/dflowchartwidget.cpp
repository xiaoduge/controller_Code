...
DFlowChartWidget::DFlowChartWidget(QWidget *parent) :
    QWidget(parent)
{
    loadPixmap();
    initDefaultValue();
...
void DFlowChartWidget::updSourceTank(float fvalue)
{
}
...
void DFlowChartWidget::paintGenie_G(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_G_HPCIR(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_G_Tags(QPainter &painter)
{
...
void DFlowChartWidget::painterGenie_G_Value(QPainter &painter)
{
    QString strUs  = tr("us");
    int iPrecision = 1;
...
void DFlowChartWidget::paintGenie_G_TankLevel(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_E(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_E_HPCIR(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_E_Tags(QPainter &painter)
{
    QFont oldFont = painter.font();
    painter.setFont(QFont("", 12, QFont::Bold));
    painter.drawText(370, 208, "N1");
...
void DFlowChartWidget::painterGenie_E_Value(QPainter &painter, bool isHPCir)
{
    int iPrecision = 1;
    QString strUs  = tr("us");
...
void DFlowChartWidget::paintGenie_E_TankLevel(QPainter &painter)
{
    QColor levelColor(40, 150, 200);
    QPen oldPen = painter.pen();
    QBrush oldBrush = painter.brush();
...
void DFlowChartWidget::paintGenie_U(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_U_TOC(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_U_HPCIR(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_U_TOC_HPCIR(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_U_Tags(QPainter &painter, bool isHaveTOC)
{
    QFont oldFont = painter.font();
    painter.setFont(QFont("", 12, QFont::Bold));
...
void DFlowChartWidget::painterGenie_U_Value(QPainter &painter, bool isHPCir, bool isHaveTOC)
{
    int iPrecision = 1;
    QString strUs  = tr("us");
...
void DFlowChartWidget::paintGenie_U_TankLevel(QPainter &painter)
{
    QColor levelColor(40, 150, 200);
    QPen oldPen = painter.pen();
    QBrush oldBrush = painter.brush();
...
void DFlowChartWidget::paintGenie_R(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_R_HPCIR(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_R_Tags(QPainter &painter)
{
    QFont oldFont = painter.font();
    painter.setFont(QFont("", 12, QFont::Bold));
...
void DFlowChartWidget::painterGenie_R_Value(QPainter &painter, bool isHPCir)
{
    int iPrecision = 1;
    QString strUs  = tr("us");
...
void DFlowChartWidget::paintGenie_R_TankLevel(QPainter &painter)
{
    QColor levelColor(40, 150, 200);
    QPen oldPen = painter.pen();
    QBrush oldBrush = painter.brush();
...
void DFlowChartWidget::paintGenie_PURIST(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_PURIST_TOC(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_PURIST_Tags(QPainter &painter, bool isHaveTOC)
{
    QFont oldFont = painter.font();
    painter.setFont(QFont("", 12, QFont::Bold));
...
void DFlowChartWidget::painterGenie_PURIST_Value(QPainter &painter, bool isHaveTOC)
{
    int iPrecision = 1;
    QString strUs  = tr("us");
...
void DFlowChartWidget::paintGenie_A(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_A_TOC(QPainter &painter)
{
...
void DFlowChartWidget::paintGenie_A_Tags(QPainter &painter, bool isHaveTOC)
{
    QFont oldFont = painter.font();
    painter.setFont(QFont("", 12, QFont::Bold));
...
void DFlowChartWidget::painterGenie_A_Value(QPainter &painter, bool isHaveTOC)
{
    int iPrecision = 1;
    QString strUs  = tr("us");
