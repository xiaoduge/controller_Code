...
static const char qt_meta_stringdata_DPushButton[] = {
    "DPushButton\0"
};
...
const QMetaObjectExtraData DPushButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_DPushButton,
      qt_meta_data_DPushButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DPushButton::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DPushButton))
